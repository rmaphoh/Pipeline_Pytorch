...
def process(image_list, save_path):
    ...
    Data4stage2 = pd.DataFrame({'Name':name_list, 'radius_list':radius_list, 'Scale_resolution':scale_resolution})
    Data4stage2.to_csv('../Results/M0/test_outside.csv', index = None, encoding='utf8')
